...
(function(){
  function apply(){
    ...
    side.innerHTML=`<div class="qf-sidebar-head"><div class="qf-logo">Q</div><div><div class="qf-name">QUIMFLUX</div><div class="qf-sub">Administrador de Planta</div></div></div><div class="qf-section-label">OPERACIÓN</div><div class="qf-nav"></div><div class="qf-sidebar-foot"><span class="qf-live-dot"></span> Sistema en línea</div>`;
    ...
    top.innerHTML=`<div><div class="qf-page-context">CENTRO DE CONTROL</div><div class="qf-welcome">Administración de Planta</div></div><div class="qf-top-actions"><span class="qf-status"><i></i> EN LÍNEA</span></div>`;
