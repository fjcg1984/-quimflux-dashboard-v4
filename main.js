...
const SUPABASE_KEY = 'sb_publishable_sULeDyfJ1l5xfvUeXRKA_bsim9qSe';
...
function avg(a,k){
  return a.length
    ? a.reduce((s,r)=>s+n(r[k]),0)/a.length
    : 0;
}
