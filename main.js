...
function renderDashboard() {
  ...
  /*
   * Las horas de parada provenientes
   * del módulo Mantenimiento se incorporan
   * al indicador de disponibilidad.
   *
   * Si todavía no existen mantenimientos,
   * se conservan las horas registradas
   * en Registro Diario.
   */
