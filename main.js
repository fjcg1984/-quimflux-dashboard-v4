...
function renderDashboard() {
  ...
  const cumplimiento =
    programada ? producida / programada : 0;
      ...
      <section class="panel">
        ...
        <div class="cards">
          ...
          <div class="card">
            ...
            <strong>${paradas.toFixed(1)}</strong>
          </div>
      ...
      <section class="panel">
        ...
        <div class="cards">
          ...
          <div class="card">
            ...
            <strong>S/ ${costoUnitario.toFixed(3)}</strong>
          </div>
          ...
          <div class="card">
            ...
            <strong>${energiaUnit.toFixed(3)} kWh/unidad</strong>
          </div>
